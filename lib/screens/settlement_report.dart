...
class SettlementReportScreen extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Icon(
                    isProfit ? Icons.check_circle_outline_rounded : Icons.error_outline_rounded,
                ...
                // Hiển thị số tiền sau cùng thiết kế nổi bật
                Container(
                ...
                if (type == "B") _row("Hệ số bồi hoàn", result["multiplier"].toString()),
                ...
                _row(
                  ...
                  type == "A" ? "${result["retained"]} vé" : "${result["retained"]} điểm",
                ),
                if (type == "B") _row("Giá bán / điểm", _formatMoney(result["ticketPrice"])),
                ...
                _row("Tổng tiền ban đầu (giữ + hồng)", _formatMoney(result["totalRetained"])),
                _row("Tiền phải bồi hoàn", _formatMoney(result["refundMoney"]), valueColor: Colors.red[700]),
  ...
  Widget _row(String title, String value, {bool isHighlight = false, Color? valueColor}) {
    return Padding(
